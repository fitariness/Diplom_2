...
class StellarBurgersApi:
    ...
    def register_user(self, payload: dict) -> requests.Response:
        return requests.post(self._url(urls.REGISTER_ENDPOINT), json=payload)

    @allure.step("POST /auth/register - регистрация пользователя")
    def register_user_with_required_fields(
    ...
    def create_order_with_auth(
        ...
        return requests.post(
            self._url(urls.ORDERS_ENDPOINT),
